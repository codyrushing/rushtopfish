...
* `bun run dev` - run the site locally at [http://localhost:4321]
  * To use the admin panel to author content, you will also want to cd to the root of the repo and run `bunx decap-server`, which makes the admin editor accessible on [http://localhost:4321/admin]\
